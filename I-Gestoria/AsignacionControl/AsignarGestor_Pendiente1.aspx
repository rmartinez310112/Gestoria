                          ...
                          <table border="0" style="text-align:center;width:90%">
                           ...
                           <tr>
                             ...
                             <td align="left" class="table_td"> 
                              <telerik:RadTextBox ID="txtPoliza" runat="server"></telerik:RadTextBox>
                             </td>
                             <td align="right" class="table_td">
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                               ...
                               <td align="left" class="table_td">
                                ...
                                <td align="right" class="table_td">
                                   <asp:RadioButtonList ID="RadioButtonList1" runat="server" Visible="False" 
                                        Width="109px">
                                       <asp:ListItem Selected="True" Value="0">Nombre Asegurado</asp:ListItem>
                                   </asp:RadioButtonList>
                               </td>
                               <td align="left" class="table_td">
                                   &nbsp;</td>
                           ...
                           <td colspan="8" align="right" class="table_td"><br />
                                <asp:CheckBox ID="chkJuridico" runat="server" 
            Text="Ocultar servicios juridicos." Font-Size="Small" ForeColor="White" />
                               <br />
                           </td>
                    ...
                    <asp:UpdatePanel ID="UpdatePanelGrid" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <telerik:RadButton ID="btnDetalleGestor" runat="server" 
                                Text="Detalle de Contacto" Visible="False">
                            </telerik:RadButton>
