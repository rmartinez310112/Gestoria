...
Partial Class AsignacionControl_ControlTermino_DetalleRecepcion
    ...
    Public Sub LlenaGrid()
        ...
        dt = csBaseGes.LlenaBitacoraGuia(Session("NumGestionControlTerm"))
        ...
        If dt.Rows.Count <> 0 Then
            ...
            DV.Sort = "Fecha_Recepcion"

            GridDetalleRecepcion.CurrentPageIndex = 0
            GridDetalleRecepcion.DataSource = DV
