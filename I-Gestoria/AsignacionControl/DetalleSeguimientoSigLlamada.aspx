<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DetalleSeguimientoSigLlamada.aspx.vb" Inherits="FrontOffice_DetalleSeguimientoSigLlamada" %>
                        ...
                        <tr>
                            <td>
                                                                    <asp:Label ID="Label4" runat="server" 
                                                                        Text="Detalle de Seguimiento a Cita."></asp:Label>
                                                                </td>
                        </tr>
                        <tr>
                            <td>
