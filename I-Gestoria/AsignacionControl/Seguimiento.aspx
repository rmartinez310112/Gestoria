                          ...
                          <table border="0" style="text-align:center;width:90%">
                           ...
                           <tr>
                                <td align="right" class="table_td">
                                    <asp:Label ID="idpoliza" runat="server" ForeColor="White" Font-Size="Small" Text="Póliza:" ></asp:Label>
                                </td>
                             <td align="left" class="table_td"> 
                              <telerik:RadTextBox ID="tbPoliza" runat="server"></telerik:RadTextBox>
                             </td>
                             <td align="right" class="table_td">
                                 <asp:Label ID="Label4" runat="server" ForeColor="White" Font-Size="Small" Text="Cliente:" ></asp:Label>
                             </td>
                             <td align="left" class="table_td"> 
                               <telerik:RadComboBox  ID="cmbCliente" runat="server"></telerik:RadComboBox>
                             </td>
                             <td align="left" class="style90" rowspan="2">
                                 <asp:Label ID="Label29" runat="server" Text="Seleccionar:" ForeColor="White"></asp:Label>
                                 <asp:RadioButtonList ID="RadioButtonList2" runat="server" AutoPostBack="True" 
                                     Font-Size="Smaller" Width="149px">
                                     <asp:ListItem Selected="True" Value="0">Fecha Activacion</asp:ListItem>
                                     <asp:ListItem Value="1">Fecha Cita</asp:ListItem>
                                 </asp:RadioButtonList>
                             </td>
                             <td align="right" class="table_td">
                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                               <asp:Label ID="Finicio" runat="server" ForeColor="White" Font-Size="Small" 
                                     Text="Fecha de Inicio Cita:" ToolTip="Es contra fecha de cita" ></asp:Label>
                             </td>
                             <td align="left" class="table_td">
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                             ...
                             <td align="right" class="style87">
                               <asp:Label ID="Ffinal" runat="server" ForeColor="White" Font-Size="Small" 
                                     Text="Fecha Final Cita:" ToolTip="Es contra fecha de cita" ></asp:Label>
                             </td>
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                           ...
                           <tr>
                             ...
                             <td align="left" class="table_td"> 
                                 &nbsp;</td>
                             <td align="right" class="table_td">
                               <asp:Label ID="Finicio0" runat="server" ForeColor="White" Font-Size="Small" 
                                     Text="Fecha de Inicio Activacion:" 
                                     ToolTip="Es contra fecha de Activacion" ></asp:Label>
                             </td>
                             <td align="left" class="table_td">
                              <telerik:RadDatePicker ID="rdDtpFI0" runat="server" Culture="es-MX">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False"></Calendar>
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                             ...
                             <td align="right" class="style87">
                               <asp:Label ID="Ffinal0" runat="server" ForeColor="White" Font-Size="Small" 
                                     Text="Fecha Final Activacion:" ToolTip="Es contra fecha de Activacion" ></asp:Label>
                             </td>
                             <td align="left" class="style89">
                              <telerik:RadDatePicker ID="rdDtpFF0" runat="server" Culture="es-MX">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False"></Calendar>
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
                           ...
                           <tr>
                               ...
                               <td align="left" class="table_td">
                                  <telerik:RadComboBox ID="cmbEstado" runat="server" Culture="es-ES">
                                      <Items>
                           ...
                           <tr>
                               ...
                               <td align="left" class="style89">
                                   <asp:RadioButtonList ID="RadioButtonList1" runat="server" Visible="False">
                                       <asp:ListItem Selected="True" Value="0">Fecha Cita</asp:ListItem>
                                   </asp:RadioButtonList>
                               </td>
                           </tr>
                           <tr>
