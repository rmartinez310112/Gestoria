<%@ Page Language="VB" MasterPageFile="~/MasterPageGestionOperativa.master" AutoEventWireup="false" CodeFile="BuscarServiciosGestoria.aspx.vb" Inherits="AsignacionControl_BuscarServiciosGestoria" %>
									...
									<fieldset style="background-color: #808080">
										<table border="0" style="text-align:center;width:90%">
											...
											<tr>
												...
												<td align="right" class="table_td">
													<asp:Label ID="Placas" runat="server" Font-Size="Small" ForeColor="White" 
                                                        Text="Placas"></asp:Label>
                                                </td>
												<td align="left" class="table_td">
													<telerik:RadTextBox ID="txtPlacas" runat="server">
                                                    </telerik:RadTextBox>
                                                </td>
												<td align="right" class="table_td">
													&nbsp;</td>
											...
											<tr>
												...
												<td align="right" class="table_td">
													<asp:Label ID="idpoliza8" runat="server" Font-Size="Small" ForeColor="White" 
