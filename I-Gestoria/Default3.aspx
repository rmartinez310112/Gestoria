<%@ Page Language="VB" MasterPageFile="~/MasterPageGestionOperativa.master" AutoEventWireup="false" CodeFile="Default3.aspx.vb" Inherits="Default3" %>
                    ...
                    <tr>
                        <td>
                            <telerik:RadTextBox ID="RadTxtObservacion" Runat="server" Height="69px" 
                                                TextMode="MultiLine" Width="552px">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
