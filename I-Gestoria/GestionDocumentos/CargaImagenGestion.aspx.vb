...
Inherits System.Web.UI.Page
    ...
    Protected Sub cmdSubir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdSubir.Click
        ...
        Dim p_estado As String = Mid(sGestion, 9, 2)
        Dim p_consec As String = Mid(sGestion, 11, nLargo)
        Dim Tramite_clvTramite As Integer = Request.QueryString("Tramite_clvTramite")
        Dim Tramite_cvlSubTramite As Integer = Request.QueryString("Tramite_cvlSubTramite")
        Dim Tramite_TipoPersona As Integer = Request.QueryString("Tramite_TipoPersona")
        Dim Tramite_servVeh As Integer = Request.QueryString("Tramite_servVeh")
