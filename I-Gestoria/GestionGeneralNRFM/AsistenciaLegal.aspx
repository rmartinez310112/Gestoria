<%@ Page Language="VB" MasterPageFile="~/MasterPageGestionOperativa.master" AutoEventWireup="false" CodeFile="AsistenciaLegal.aspx.vb" Inherits="GestionGeneralNRFM_AsistenciaLegal" %>
    ...
    <div class="Preguntas">
        ...
        <div>
            ...
            <td colspan="2">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label37" runat="server" Text="E-mail:" CssClass="letrasdetodo"></asp:Label>
                    </td>
                    <td>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <asp:Label ID="Label40" runat="server" 
                            Text="Informacion adicional en caso de asistencia legal por siniestro:" 
                            CssClass="letrasdetodo"></asp:Label>
                    </td>
                </tr>
            </table>
                 ...
                 <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="style5">
                            <asp:Label ID="Label17" runat="server" Text="El conductor esta detenido:" 
                                CssClass="letrasdetodo"></asp:Label>
                        </td>
                        <td class="style6">
                            <asp:RadioButtonList ID="rdoConductor" runat="server" CssClass="letrasdetodo" 
                                RepeatDirection="Horizontal">
                                <asp:ListItem Selected="True" Value="1">Si</asp:ListItem>
                                <asp:ListItem Value="2">No</asp:ListItem>
                            </asp:RadioButtonList>
                    ...
                    <tr>
                        <td style="width:300px">
                            <asp:Label ID="Label24" runat="server" Text="El vehiculo esta detenido:" 
                                CssClass="letrasdetodo"></asp:Label>
                        </td>
                        <td style="width:200px">
                            <asp:RadioButtonList ID="rdoVehiculoDet" runat="server" CssClass="letrasdetodo" 
                                RepeatDirection="Horizontal">
                                <asp:ListItem Selected="True" Value="1">Si</asp:ListItem>
                                <asp:ListItem Value="2">No</asp:ListItem>
                            </asp:RadioButtonList>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="Label25" runat="server" Text="Cargo Inicial:" 
                                CssClass="letrasdetodo"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <asp:RadioButtonList ID="rdoCargoIni" runat="server" CssClass="letrasdetodo" 
                                RepeatDirection="Horizontal">
                                <asp:ListItem Selected="True" Value="1">Ofendido</asp:ListItem>
                                <asp:ListItem Value="2">Responsable</asp:ListItem>
                                <asp:ListItem Value="3">Corresponsable</asp:ListItem>
                                <asp:ListItem Value="4">No definido</asp:ListItem>
									...
									<td>
										<asp:Panel ID="Panel2" runat="server" Visible="False">
											<table cellspacing="1" class="style7">
												<tr>
													<td class="style83">
														<asp:Label ID="Label29" runat="server" CssClass="Titulos" 
