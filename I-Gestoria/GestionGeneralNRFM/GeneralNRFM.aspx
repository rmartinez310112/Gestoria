<%@ Page Language="VB" MasterPageFile="~/MasterPageGestionOperativa.master" AutoEventWireup="false" CodeFile="GeneralNRFM.aspx.vb" Inherits="GestionGeneralNRFM_GeneralNRFM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadioButtonList ID="rdoLeasing" runat="server" CssClass="letrasdetodo" 
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:CheckBox ID="chkPAgoEvento" runat="server" CssClass="letrasdetodo" 
                                        Text="Pago x Evento" 
                                        ToolTip="Cuando el servicio se de por pago x evento marcar estar opción" 
                                        Enabled="False" />
                                </td>
                            </tr>
                            </table>
            ...
            <td>
             ...
             <td>&nbsp;</td>
              <td>&nbsp;</td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblFisica" runat="server" CssClass="letrasdetodo" 
                            Text="Persona Fisica"></asp:Label>
                    </td>
                    <td>
                    </td>
                    <td>
    ...
    <div class="Titulo">
        <asp:Label ID="Label40" runat="server" Text="Distribuidor:" 
            CssClass="letrasdetodo"></asp:Label>

    </div>
    <div class="Preguntas">
     
        <telerik:RadComboBox ID="cboDistribuidor" runat="server" AutoPostBack="True" 
    ...
    <div>
        ...
        <table>
                                    <tr>
                                        <td colspan="3">
                                            <asp:Label ID="Label106" runat="server" 
                                                Text="Persona con quien se entrevistara:" CssClass="letrasdetodo"></asp:Label>
                                        </td>
                                        <td style="width:100px">
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td style="width:60px">
                                            <asp:Label ID="Label107" runat="server" Text="Nombre:" CssClass="letrasdetodo"></asp:Label>
                                        </td>
                                        <td colspan="3">
                                            <asp:TextBox ID="txt_NomEnt" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:60px">
                                            <asp:Label ID="Label108" runat="server" Text="Lada:" CssClass="letrasdetodo"></asp:Label>
                                        </td>
                                        <td style="width:100px">
                                            <asp:TextBox ID="txt_LadaEnt" runat="server"></asp:TextBox>
                                        </td>
                                        <td style="width:100px">
                                            <asp:Label ID="Label109" runat="server" Text="Telefono:" 
                                                CssClass="letrasdetodo"></asp:Label>
                                        </td>
                                        <td style="width:100px">
                                            <asp:TextBox ID="txt_TelEnt" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:60px">
									...
									<td>
										<asp:Panel ID="Panel2" runat="server" Visible="False">
											<table cellspacing="1" class="style7">
												<tr>
													<td class="style83">
														<asp:Label ID="Label7" runat="server" CssClass="Titulos" 
