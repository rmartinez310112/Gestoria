<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPageGestionOperativa.master" AutoEventWireup="false" CodeFile="GestionPTxRobo.aspx.vb" Inherits="GestionPerdidaTotal_GestionPTxRobo" %>
...
<div>
		...
		<table cellspacing="1" class="style7">
					...
					<div class="exampleWrapper">
						<telerik:RadTabStrip ID="RadTabStrip1" runat="server" Skin="Black" MultiPageID="RadMultiPage1"
							...
							<Tabs>
                                ...
                                <telerik:RadTab Text="Telefonos Extra" PageViewID="RadPageView4">
								</telerik:RadTab>
							</Tabs>
						</telerik:RadTabStrip>
									...
									<tr>
										<td colspan="3">
											<asp:Label ID="Label1" runat="server" CssClass="Titulos" 
													   Text="Gestión  Perdida Total X Robo"></asp:Label>
										</td>
									</tr>
									<tr>
										<td colspan="3">
                    ...
                    <td>
                        <asp:RadioButtonList ID="rdoLeasing" runat="server" CssClass="letrasdetodo" 
                            ...
                            <asp:ListItem Selected="True" Value="2">No</asp:ListItem>
									...
									<tr>
										<td colspan="3">
											<asp:Label ID="Label7" runat="server" CssClass="letrasdetodo" 
													   Text="Fecha en que ocurrio el Siniestro:"></asp:Label>
										</td>
									</tr>
									<tr>
										<td colspan="3">
											<table cellspacing="1" class="style64">
												<tr>
													<td>
														<asp:Label ID="Label23" runat="server" CssClass="letrasdetodo" Text="Fecha"></asp:Label>
													</td>
													<td class="style58">
														<asp:Label ID="Label24" runat="server" CssClass="letrasdetodo" Text="Hora"></asp:Label>
													</td>
												</tr>
												<tr>
													<td class="style63">
														<telerik:RadDatePicker ID="txtFechaOcur" runat="server" MinDate="">
														</telerik:RadDatePicker>
													</td>
													<td class="style65">
														<telerik:RadTimePicker ID="txtHoraOcurr" runat="server" MinDate="">
												...
												<tr>
													<td class="style67">
														<telerik:RadTextBox ID="txtNoPoliza" runat="server" CssClass="TxtBox" 
																			EmptyMessage="Obligatorio" Width="100%" Enabled="False" ReadOnly="True">
															<EmptyMessageStyle BackColor="#6666FF" ForeColor="Black" />
														</telerik:RadTextBox>
													</td>
													<td class="style77">
													...
													<td class="style60">
														<telerik:RadTextBox ID="txtContrato" runat="server" CssClass="TxtBox" 
																			Enabled="False" ReadOnly="True">
														</telerik:RadTextBox>
													</td>
												</tr>
									...
									<tr>
										<td class="style85">
											<asp:Label ID="Label63" runat="server" Text="Estatus de la póliza" 
									...
									<tr>
										<td class="style85">
											<asp:Label ID="Label64" runat="server" Text="Inicio Vigencia:" 
													   CssClass="letrasdetodo"></asp:Label>
										</td>
										<td>
									...
									<tr>
										<td class="style85">
											<asp:Label ID="Label65" runat="server" Text="Fin de Vigencia:" 
													   CssClass="letrasdetodo"></asp:Label>
										</td>
										<td>
									...
									<tr>
                                        <td class="style85">
                                            <asp:Label ID="Label120" runat="server" CssClass="letrasdetodo" 
                                                Text="Folio Aseguradora:"></asp:Label>
                                        </td>
                                        <td>
                                            <telerik:RadTextBox ID="txtFolioEnlaceAseg" Runat="server" Enabled="False">
                                            </telerik:RadTextBox>
                                        </td>
                                        <td>
                                            &nbsp;</td>
									...
									<tr>
										<td colspan="3">
											<telerik:RadTextBox ID="RadTxtGoControl" Runat="server" CssClass="TxtBox">
											</telerik:RadTextBox>
										</td>
									</tr>
									<tr>
										<td colspan="3">
											<asp:Label ID="Label67" runat="server" 
													   Text="La poliza se encuentra a su nombre" CssClass="letrasdetodo"></asp:Label>
										</td>
									</tr>
									<tr>
										<td colspan="3">
											<asp:RadioButtonList ID="rblAseg" runat="server" CssClass="letrasdetodo" 
																 RepeatDirection="Horizontal">
										...
										<td colspan="2">
											<table cellpadding="0" cellspacing="0">
												...
												<tr>
													...
													<td>
														<telerik:RadTextBox ID="txtNomAseg" runat="server" CssClass="TxtBox" Width="95%"
												...
												<tr>
													<td class="style2" colspan="2">
														<asp:CheckBox ID="chkMoral" runat="server" AutoPostBack="True" 
																	  CssClass="letrasdetodo" Text="Persona Moral" Width="433%" />
													</td>
													<td>
									...
									<tr>
										<td colspan="2">
											<table cellspacing="1">
												...
												<tr>
													<td>
														<asp:Label ID="Label55" runat="server" CssClass="letrasdetodo" Text="Celular"></asp:Label>
													</td>
													<td class="style77">
														&nbsp;
													</td>
												...
												<tr>
													<td class="style60">
														<asp:Label ID="Label68" runat="server" CssClass="letrasdetodo" Text="Lada"></asp:Label>
													</td>
													<td class="style77">
														<asp:Label ID="Label103" runat="server" CssClass="letrasdetodo" Text="Telefono"></asp:Label>
													</td>
													<td class="style60">
														&nbsp;
													</td>
												...
												<tr>
													<td class="style60">
														<telerik:RadTextBox ID="txtLadaAseg0" runat="server" CssClass="TxtBox" 
																			 Width="50px">
															
														</telerik:RadTextBox>
													</td>
													<td class="style77">
														<telerik:RadNumericTextBox ID="txtTelMovil" Runat="server" CssClass="TxtBox">
                                                ...
                                                <td>
                                                    <asp:Label ID="Label121" runat="server" CssClass="letrasdetodo" 
            ...
            <td colspan="2">
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label33" runat="server" Text="E-mail:" CssClass="letrasdetodo"></asp:Label>
                    </td>
                    <td>
                    ...
                    <td style="width:200px">
                        <telerik:RadComboBox ID="cboMotivoNoCorreo" runat="server" AutoPostBack="True" 
                            Skin="Forest" Width="95%">
									...
									<tr>
										<td colspan="2">
											<asp:Label ID="Label75" runat="server" CssClass="letrasdetodo" 
													   Text="Me puede proporcionar los datos del Credito/Contrato"></asp:Label>
										</td>
									</tr>
									<tr>
										<td style="width:200px">
											<asp:Label ID="Label76" runat="server" CssClass="letrasdetodo" 
													   Text="No. de credito"></asp:Label>
										</td>
										<td>
											<telerik:RadTextBox ID="txtnocredito" runat="server" CssClass="TxtBox" Width="160px">
											</telerik:RadTextBox>
										</td>
									</tr>
									<tr>
										<td style="width:200px">
											<asp:Label ID="Label78" runat="server" CssClass="letrasdetodo" 
													   Text="Inicio de Vigencia:"></asp:Label>
										</td>
										<td>
											<telerik:RadDatePicker ID="txtFechaInicioCred" runat="server" MinDate="" 
												Enabled="False">
											</telerik:RadDatePicker>
										</td>
									</tr>
									<tr>
										<td style="width:200px">
											<asp:Label ID="Label79" runat="server" CssClass="letrasdetodo" 
													   Text="Fin de Vigencia:"></asp:Label>
										</td>
										<td>
											<telerik:RadDatePicker ID="txtFechaFinCred" runat="server" MinDate="" 
												Enabled="False">
											</telerik:RadDatePicker>
										</td>
									</tr>
									<tr>
										<td style="width:200px">
											<asp:Label ID="Label80" runat="server" CssClass="letrasdetodo" 
										...
										<td colspan="2">
											<table border="0" cellpadding="0" cellspacing="0">
												...
												<tr>
													...
													<td >
														<telerik:RadComboBox ID="cboSubmarca" runat="server" Width="200px">
														</telerik:RadComboBox>
													</td>
												</tr>
												<tr>
												...
												<tr>
													<td>
														<telerik:RadTextBox ID="txtModelo" runat="server"  
																			EmptyMessage="Obligatorio" Width="150px" CssClass="TxtBox">
															<EmptyMessageStyle BackColor="#6666FF" ForeColor="Black" />
														</telerik:RadTextBox>
													</td>
													<td>
														<telerik:RadTextBox ID="txtColor" runat="server" Width="99%" CssClass="TxtBox">
														</telerik:RadTextBox>
													</td>
												</tr>
												<tr>
												...
												<tr>
													<td>
														<telerik:RadTextBox ID="txtPlacas" runat="server" CssClass="TxtBox" Width="150px">
														</telerik:RadTextBox>
													</td>
													<td class="style2">
														<telerik:RadTextBox ID="txtSerie" runat="server" CssClass="TxtBox" Width="99%">
														</telerik:RadTextBox>
													</td>
												</tr>
												<tr>
													<td>
														<asp:Label ID="Label71" runat="server" CssClass="letrasdetodo" 
																   Text="Tipo de uso del Vehiculo"></asp:Label>
													</td>
													<td >
														<asp:Label ID="Label72" runat="server" CssClass="letrasdetodo" 
																   Text="Tipo de Carga"></asp:Label>
													</td>
												</tr>
												<tr>
													<td>
													...
													<td>
														<telerik:RadTextBox ID="txtTipoCarga" runat="server" CssClass="TxtBox" 
																			Width="99%">
														</telerik:RadTextBox>
													</td>
												</tr>
												<tr>
													<td>
														<asp:Label ID="Label73" runat="server" CssClass="letrasdetodo" Text="Paquete:"></asp:Label>
													</td>
													<td>
														<asp:Label ID="Label74" runat="server" CssClass="letrasdetodo" Text="Descripción:"></asp:Label>
													</td>
												</tr>
												<tr>
													<td>
														<telerik:RadTextBox ID="txtPaquete" runat="server" CssClass="TxtBox" Width="150px">
														</telerik:RadTextBox >
													</td>
													<td class="style2">
														<telerik:RadTextBox ID="txtDescripcion" runat="server" CssClass="TxtBox" 
																			Width="99%">
														</telerik:RadTextBox>
													</td>
												</tr>
												...
												<tr>
													...
													<table>
														<tr>
															<td>
																<asp:Label ID="Label5" runat="server" CssClass="letrasdetodo" Text="Lada"></asp:Label>
															</td>
															<td colspan="4">
																<asp:Label ID="Label6" runat="server" CssClass="letrasdetodo" Text="Telefono"></asp:Label>
															</td>
															<td>
																&nbsp;
															</td>
												...
												<tr>
													<td class="style73" colspan="6">
														<asp:Label ID="Label97" runat="server" CssClass="letrasdetodo" 
															Text=" Estado y Municipio donde está dado de alta el vehículo (De dónde son las Placas)."></asp:Label>
													</td>
												</tr>
												<tr>
													<td>
														<asp:Label ID="Label98" runat="server" CssClass="letrasdetodo" Text="Estado"></asp:Label>
													</td>
													<td>
														<asp:Label ID="Label99" runat="server" CssClass="letrasdetodo" Text="Municipio"></asp:Label>
													</td>
												</tr>
												<tr>
													<td style="width: 100px">
														<telerik:RadComboBox ID="cboEstadoPlacas" runat="server" AutoPostBack="True" 
															Width="200px">
														</telerik:RadComboBox>
													</td>
													<td style="width: 100px">
														<telerik:RadComboBox ID="cboMpioPlacas" runat="server" Width="99%">
														</telerik:RadComboBox>
													</td>
												</tr>
												<tr>
												<td class="style73" colspan="6">
													<asp:Label ID="Label14" runat="server" CssClass="letrasdetodo" 
														Text=" Cuenta con copia certificada de la Averiguacion Previa (solo aplica si la PT fue por robo)"></asp:Label>
														
												</td>
												</tr>
													<tr>
														<td>
															<asp:Label ID="Label101" runat="server" CssClass="letrasdetodo" 
																Text="No. de Averiguación"></asp:Label>
														</td>
														<td>
															<asp:Label ID="Label102" runat="server" CssClass="letrasdetodo" Text="Fecha"></asp:Label>
														</td>
													</tr>
													<tr>
														<td style="width:150px">
															<telerik:RadTextBox ID="txtNoAverig" runat="server" CssClass="TxtBox" 
																Width="150px">
															</telerik:RadTextBox>
														</td>
														<td class="style2">
															<telerik:RadDatePicker ID="txtFechaAver" runat="server" MinDate="">
															</telerik:RadDatePicker>
														</td>
													</tr>
