<%@ Page Language="VB" MasterPageFile="~/MasterPageGestionOperativa.master" AutoEventWireup="false" CodeFile="Avances.aspx.vb" Inherits="TableroGestion_Avances" %>


<%@ Register src="../ucAvance/TotalesAvance.ascx" tagname="TotalesAvance" tagprefix="uc1" %>
...
<%@ Register src="../ucAvance/Combo.ascx" tagname="Combo" tagprefix="uc4" %>
<%@ Register src="../ucAvance/Fechas.ascx" tagname="Fechas" tagprefix="uc5" %>
             ...
             <td colspan="2">
               <asp:UpdatePanel ID="udpFiltro" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <uc5:Fechas ID="SelectorFechas" runat="server" Visible="false" />
                        <uc4:Combo ID="ComboMes" runat="server" Visible="false" />
                    </ContentTemplate>
               </asp:UpdatePanel>
            </td>
...
<HeaderStyle Width="20px"></HeaderStyle>
   ...
   <HeaderStyle Font-Bold="true" ForeColor="White" Font-Size="10"/>
    <Columns>
        ...
        <telerik:GridBoundColumn FilterControlAltText="Filter column1 column" 
            HeaderText="En Proceso   #" UniqueName="column1" DataField="terminados">
        </telerik:GridBoundColumn>
...
<FilterMenu EnableImageSprites="False"></FilterMenu>
        ...
        <td>
         <telerik:RadNotification ID="RadNotification1" runat="server">
            ...
            <uc1:TotalesAvance ID="TotalesAvance1" runat="server" />
