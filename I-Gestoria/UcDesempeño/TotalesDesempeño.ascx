<%@ Control Language="VB" AutoEventWireup="false" CodeFile="TotalesDesempeño.ascx.vb" Inherits="UserControls_Totales" %>
...
<tr>
  ...
  <%-- <asp:Label Font-Size="Small" ID="lblNC" runat="server" ></asp:Label>--%>
   ...
   <asp:Label Font-Size="Medium" ID="lblAntes" runat="server" 
          ForeColor="#2B3990" Font-Bold="true" CssClass="totales"></asp:Label>
